        ...
        <form method="post" action="{{ route('admin.nganh.store') }}">
            ...
            <div class="intro-y box p-5">
                <div>
                    ...
                    <input id="title" name="title" type="text" class="form-control" placeholder="Tên ngành" required>
                </div>
                <div class="mt-3">
                ...
                <div class="mt-3">
                    ...
                    <input id="slug" name="slug" type="text" class="form-control" placeholder="Slug" required>
                </div>
                <div class="mt-3">
