...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('enrollments', function (Blueprint $table) {
            ...
            $table->integer('tracnghiem_point')->default(0); // Thời gian đã học
            $table->integer('tuluan_point')->default(0); // Thời gian đã học
            $table->integer('time_point')->default(0); // Thời gian đã học
