            ...
            <form method="post" action="{{route('admin.hocphan.update', $hocphan->id)}}" enctype="multipart/form-data">
                ...
                <div class="intro-y box p-5">
                    ...
                    <div class="mt-3">
                        ...
                        <input name="time_point" type="text" class="form-control" value="{{$hocphan->time_point}}">
                    </div>
                    <div class="mt-3">
                        <label for="regular-form-1" class="form-label">Trắc nghiệm</label>
                        <input name="tracnghiem_point" type="text" class="form-control" value="{{$hocphan->tracnghiem_point}}">
                    </div>
                    <div class="mt-3">
                        <label for="regular-form-1" class="form-label">Tự luận</label>
                        <input name="tuluan_point" type="text" class="form-control" value="{{$hocphan->tuluan_point}}">
                    </div>
...
<script>
 Dropzone.autoDiscover = false;
    ...
    // Dropzone class:
        ...
        Dropzone.instances[0].options.acceptedFiles= "image/jpeg,image/png,image/gif,image/webp,image/webp";
