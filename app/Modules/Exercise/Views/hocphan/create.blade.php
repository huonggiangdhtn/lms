...
<div class="content">
    ...
    <div class="grid grid-cols-12 gap-12 mt-5">
        <div class="intro-y col-span-12 lg:col-span-12">
            <!-- BEGIN: Form Layout -->
            <form method="post" action="{{route('admin.hocphan.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="intro-y box p-5">
                    ...
                    <div class="mt-3">
                        ...
                        <input name="code" type="text" class="form-control" placeholder="mã học phần">
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        ...
                        <input name="tinchi" type="text" class="form-control" placeholder="tín chỉ">
                    </div>
                    <div class="mt-3">
                        <label for="regular-form-1" class="form-label">Thời gian</label>
                        <input name="time_point" type="text" class="form-control" placeholder="thời gian">
                    </div>
                    <div class="mt-3">
                        <label for="regular-form-1" class="form-label">Trắc nghiệm</label>
                        <input name="tracnghiem_point" type="text" class="form-control" placeholder="số điểm trắc nghiệm cần có">
                    </div>
                    <div class="mt-3">
                        <label for="regular-form-1" class="form-label">Tự luận</label>
                        <input name="tuluan_point" type="text" class="form-control" placeholder="số điểm tự luận">
                    </div>
                    {{-- <div class="mt-3">
                        <label for="regular-form-1" class="form-label">Hình thức thi</label>
                        <input name="id_hinhthucthi" type="text" class="form-control" placeholder="hình thức thi">
                    </div> --}}
...
<script>
 Dropzone.autoDiscover = false;
    ...
    // Dropzone class:
        ...
        Dropzone.instances[0].options.acceptedFiles= "image/jpeg,image/png,image/gif,image/webp";
