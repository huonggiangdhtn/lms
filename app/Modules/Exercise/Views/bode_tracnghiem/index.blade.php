    ...
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        ...
        <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
            <div class="w-56 relative text-slate-500">
                {{-- <form action="{{ route('admin.bode_tracnghiem.search') }}" method="get">
                    @csrf
                ...
                <tr class="intro-x">
                    ...
                    <td class="table-report__action w-56">
                        <div class="flex justify-center items-center">
                            <a href="{{ route('admin.bode_tracnghiem.edit', $item->id) }}" class="flex items-center mr-3"> 
                                <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Sửa 
                            </a>
                            <form action="{{ route('admin.bode_tracnghiem.destroy', $item->id) }}" method="post">
                                @csrf
                                @method('delete')
